Figure 2. Community structure (stacked bar plot)

Figure 3. Principal coordinates analysis (PCoA)

Figure 4&5. Heat tree matrix (Bacteria, Fungi)
...
Figure 6. Microbial abundance diversities and correlations with soil physico-chemistry
